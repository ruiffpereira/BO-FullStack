...
| `Ginasio.tsx` | `/ginasio` | `VIEW_GYM` | Ginásio: exercícios (catálogo + grupos/subgrupos musculares), treinos reutilizáveis, planos, programas/progresso por cliente e **Mensalidades** (dashboard financeiro + catálogo de subscrições) (`/api/gym`) |
