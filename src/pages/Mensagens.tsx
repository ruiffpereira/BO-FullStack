...
function TenantSupport() {
  return (
    <div className="flex h-[calc(100dvh-13rem)] min-h-[480px] flex-col rounded-xl border border-zinc-200/80 dark:border-zinc-800 overflow-hidden bg-white dark:bg-zinc-900">
